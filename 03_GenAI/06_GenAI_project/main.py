...
if __name__ =="__main__":
    ...
    # from langchain.tools.retriever import create_retriever_tool : 구버전
    from langchain_core.tools import create_retriever_tool

    #pip install tavily-python  
    document_tool = create_retriever_tool(
        retriever,
        "camera_document_search",
        """
        카메라 개발 및 평가 관련 문서를 검색합니다.
        사용자가 카메라, 센서, EMVA1288 관련 질문을 하면 사용하세요.
        """
    )
    ...
    tavily_tool = TavilySearchResults( max_results=3 ,tavily_api_key=tavily_key)
